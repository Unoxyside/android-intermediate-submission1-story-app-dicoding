...
import com.bahasyim.mystoryapp.databinding.ItemLoadingBinding

class LoadingStoryAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<LoadingStoryAdapter.LoadingViewHolder>() {
    ...
    class LoadingViewHolder(private val binding: ItemLoadingBinding, retry: () -> Unit) :
        ...
        fun bind(loadState: LoadState) {
            ...
            binding.refreshButton.isVisible = loadState is LoadState.Error
